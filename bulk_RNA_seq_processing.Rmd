...
### Compare to patient data (Herberle 2025) ---
# Read your DEGs
...
alz_df <- read_csv("alz70025-sup-0006-tabless10.csv") ## Extracted from frontal lobe tissue, published by Heberle 2025
...
sector_colors <- c(
  ...
  "Alzheimer's Up" = "gold",
  "Organoid Down" = "blue",
  "Alzheimer's Down" = "mediumpurple2",
  "Concordant Up" = "palevioletred2",
  "Concordant Down" = "darkturquoise",
  "Organoid Up, Alzheimer's Down" = "tan1",
...
# Run GO analysis on each sector
...
plot_go_lollipop <- function(file, output_prefix = "Lollipop_plot_") {
  ...
  p <- ggplot(top_hits, aes(y = Description)) +
    geom_segment(aes(x = 0, xend = -log10(p.adjust), yend = Description),
                 color = "grey70") +
    geom_point(aes(x = -log10(p.adjust), size = Count),
               shape = 21, color = "black", stroke = 0.5, alpha = 1, fill = 'grey75') +
    scale_size_continuous(range = c(3,7)) +
    theme_classic(base_size = 14) +
    labs(
      x = "-log10 adjusted p-value",
...
# Make plots
plot_go_lollipop("GO_sector_results/GO_OrganoidUp_all.csv")
plot_go_lollipop("GO_sector_results/GO_OrganoidDown_all.csv")
plot_go_lollipop("GO_sector_results/GO_AlzheimersUp_all.csv")
plot_go_lollipop("GO_sector_results/GO_AlzheimersDown_all.csv")
plot_go_lollipop("GO_sector_results/GO_ConcordantUp_all.csv")
plot_go_lollipop("GO_sector_results/GO_ConcordantDown_all.csv")
plot_go_lollipop("GO_sector_results/GO_OrganoidUpAlzheimersDown_all.csv")
plot_go_lollipop("GO_sector_results/GO_OrganoidDownAlzheimersUp_all.csv")

# Save dataframe with z-scores and sector designations
